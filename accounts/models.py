...
class City(models.Model):
    name = models.CharField(max_length=100)
    state= models.ForeignKey(State, related_name='cities', on_delete=models.CASCADE, blank=True, null=True)
...
class Division(models.Model):
    ...
    state = models.ForeignKey(State, related_name='state_divisions', on_delete=models.SET_NULL, blank=True, null=True)
...
class InsituteAdress(models.Model):
    institute = models.ForeignKey(Institude, on_delete=models.CASCADE, related_name='address')
    ...
    latitude = models.FloatField(blank=True) # Hidden input
    longitude = models.FloatField(blank=True) # Hidden input
    temp_latitude = models.FloatField()  # current location latitude
    temp_longitude = models.FloatField() # current location longitude 
   
    
    road_or_streetNo = models.CharField(max_length=100, blank=True, null=True)
    ...
    upozila_thana = models.CharField(max_length=100, blank=True, null=True)
    municipality = models.CharField(max_length=100, blank=True, null=True)
    union = models.CharField(max_length=100, blank=True, null=True)
    word_no = models.CharField(max_length=100, blank=True, null=True)
    village = models.CharField(max_length=100, blank=True, null=True)
    mahalla = models.CharField(max_length=100, blank=True, null=True)
    block = models.CharField(max_length=100, blank=True, null=True)
    holdingNo = models.CharField(max_length=100, blank=True, null=True)
    house = models.CharField(max_length=100, blank=True, null=True)

    def __str__(self):
        return str(self.institute)+": "+ str(self.branch_name)
...
class InstituteGroups(Group):
    ...
    members = models.ManyToManyField(User, through="MemberList",through_fields=('group', 'member'), related_name="i_groups")
...
class MemberList(models.Model):
    group=models.ForeignKey(InstituteGroups, on_delete=models.CASCADE, related_name="person_list")
    member=models.ForeignKey(User, on_delete=models.CASCADE, related_name="groups_list")
    accepted_by=models.ForeignKey(User, on_delete=models.CASCADE, related_name="controlled")
    created_at=models.DateTimeField(auto_now_add=True)
